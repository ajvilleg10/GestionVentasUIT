                  ...
                  <LocalizationProvider fullWidth dateAdapter={AdapterDayjs}>
                    <TimeField
                      ...
                      onChange={(date) => {
                        ...
                        formik.setFieldValue('updated_date.time', !formik.initialValues.hora_inicio.isSame(date));
                  ...
                  <LocalizationProvider fullWidth dateAdapter={AdapterDayjs}>
                    <TimeField
                      ...
                      onChange={(date) => {
                        ...
                        formik.setFieldValue('updated_date.time', !formik.initialValues.hora_final.isSame(date));
                  ...
                  <LocalizationProvider fullWidth dateAdapter={AdapterDayjs}>
                    <DatePicker
                      ...
                      onChange={(date) => {
                        ...
                        formik.setFieldValue('updated_date.date', !formik.initialValues.fecha_reunion.isSame(date));
                        formik.setFieldValue('fecha_reunion', date);

                        // console.log(formik.initialValues.fecha_reunion.isSame(date));
                        // formik.setFieldTouched('fecha_reunion', true, true);
                      }}
                      slotProps={{
                        textField: {
                          variant: 'outlined'
                ...
                <Grid item xs={12} md={5}>
                  <FormControl fullWidth>
                    <TextField
                      ...
                      onInput={() => formik.setFieldTouched('comentario', true, true)}
