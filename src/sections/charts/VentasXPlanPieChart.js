...
import { IconButton, Grid, Typography, useMediaQuery , Box,Select, MenuItem} from '@mui/material';
...
const VentasXPlanPieChart = () => {
  ...
  return (
    <MainCard
      ...
      secondary={
        <Box>
          <Select value="3" size="small">
            <MenuItem value="3">Venta Nueva</MenuItem>
            <MenuItem value="5">Renovación</MenuItem>
...
export default VentasXPlanPieChart;
