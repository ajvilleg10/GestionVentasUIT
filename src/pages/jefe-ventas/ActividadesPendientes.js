...
import Registro from 'pages/jefe-ventas/registro/Registro';
...
const ActividadesPendientesJefeVentas = () => {
  ...
  // console.log('tipoCuentaInfo', tipoCuentaInfo);
  // console.log('cuentaInfo', cuentaInfo);
  ...
  return (
    <>
      <JefeVentaDisplayContext.Provider value={{displayFlag, setDisplayFlag, prospecto, setProspecto}}>
        {displayFlag ? (
          <Registro volver={() => setDisplayFlag(value => !value)} prospectoVendedor={prospecto}/>
        ) : (
      ...
      </JefeVentaDisplayContext.Provider>
