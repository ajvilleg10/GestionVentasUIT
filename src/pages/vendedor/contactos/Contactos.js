        ...
        <Grid container spacing={3}>
          <Grid item xs={12}>
            <Grid container spacing={3}>
              ...
              >
                <Grid item xs={6}>
                  <AnalyticEcommerce title="Citas concretadas | Semana" count={statsBack?.citas_concreatadas} percentage={40} color="primary" />
                </Grid>
                <Grid item xs={6}>
                  <AnalyticEcommerce title="Citas | Semana" count={statsBack?.cita} percentage={40} color="primary" />
                </Grid>
                <Grid item xs={6}>
                  <AnalyticEcommerce title="Contratos x Cerrar | Semana" count={statsBack?.contratos_cerrar} percentage={40} color="error" />
                </Grid>
                <Grid item xs={6}>
                  <AnalyticEcommerce title="Contactos referidos | Semana" count={statsBack?.contactos_referidos} percentage={20} color="warning" />
                </Grid>
              </Grid>
            </Grid>
          </Grid>
