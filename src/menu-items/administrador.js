...
const administrador = {
  ...
  children: [
    ...
    {
      id: 'bonificacion-gestionb-admin',
      title: "Bonificaciones por Gestión",
      type: 'item',
      url: '/confBonificacionGestion',
      icon: icons.DollarOutlined
    },
    {
      id: 'pa-ventas-reclutamiento-admin',
      title: "Presupuesto Anual - Jefe de Ventas",
      type: 'item',
    ...
    },
    {
      ...
      title: "Tabla de Bonificaciones por Ventas",
      type: 'item',
