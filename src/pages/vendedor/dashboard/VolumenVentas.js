            ...
            <Box mt={2}>
              ...
              <TableContainer sx={{ width: '60%', overflowX: 'auto' }} style={{ width: '100%' }}>
                <Table>
                  <TableBody>
                    <TableRow>
                      <TableCell style={{ width: '600px', height: '30px', border: '40px solid #c1e6df' }}>
                        <label> Ventas x Origen </label>
                        <ApexColumnChart opciones={columnChartOptions2} series={serie2} height={350} /> </TableCell>
                      <TableCell style={{ width: '300px', height: '30px', border: '40px solid #c1e6df' }}>
                        <label> Ley de Compensación </label>
                        <AcquisitionChart opciones={barChartOptions3} series={serie6} type="bar" height={250} /> </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </TableContainer>
