          ...
          <form onSubmit={formik.handleSubmit}>
            <List sx={{ py: 2 }} dense>
              ...
              <ListItem>
                <Grid container spacing={1}>
                  <Grid item xs={12} md={3} display="flex" alignItems="center">
                    <InputLabel htmlFor="asistencias">Porcentaje de asistencia a comités</InputLabel>
                  </Grid>
                  <Grid item xs={12} md={2}>
                    <TextField
                      type="number"
                  ...
                  <Grid item xs={12} md={1} />
                  <Grid item xs={12} md={3} display="flex" alignItems="center">
                    <InputLabel htmlFor="bono_semanal_comites">Bono semanal por <br />asistencia a comités</InputLabel>
                  </Grid>
                  <Grid item xs={12} md={2}>
                    <TextField
                      type="number"
