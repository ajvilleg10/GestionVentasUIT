  ...
  useEffect(() => {
    const data = [
      {
        ...
        confirmacionAsitenciaVendedor: 'SI',
        valoracionVendedor: 'Buena',
        explicoServicio: 'SI',
        valoracionServicio: 'Excelente',
        aplicaBonoGestion: 'SI'
      },
      {
        id: 2,
        fechaSistema: '26/05/2001',
        ...
        comentarios: 'Nada que decir',
        confirmacionAsitenciaVendedor: 'SI',
        valoracionVendedor: 'Mala',
        explicoServicio: 'NO',
        valoracionServicio: 'Regular',
        aplicaBonoGestion: 'NO'
      }
    ];
    const rows = data.map((c, index) =>
      createData(
        ...
        c.fechaVerificado,
        c.comentarios,
        c.confirmacionAsitenciaVendedor,
        c.valoracionVendedor ,
        c.explicoServicio ,
        c.valoracionServicio ,
        c.aplicaBonoGestion
      )
    );
    setRows(rows);
