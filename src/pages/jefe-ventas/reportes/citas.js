          ...
          <Table sx={{ width: '100%' }} aria-label="simple table">
            <TableHead>
              <TableRow>
                ...
                <TableCell align="center">Modo de contacto</TableCell>
                <TableCell align="center">Fecha y hora de cita</TableCell>
                <TableCell align="center">Dirección de cita</TableCell>
                <TableCell align="center">Modo de verificación</TableCell>
                <TableCell align="center">Concretada</TableCell>
                <TableCell align="center">Convocado a jefe de ventas</TableCell>
                <TableCell align="center">Asistio vendedor</TableCell>
                <TableCell align="center">Confirmación de asistencia jefe de ventas</TableCell>
                <TableCell align="center">Explicó el servicio</TableCell>
                <TableCell align="center">Valoración del vendedor</TableCell>
                {/* <TableCell align="center">Valoración del servicio</TableCell> */}
                <TableCell align="center">Verificado por asistente de ventas</TableCell>
                <TableCell align="center">Fecha de verificación</TableCell>
                <TableCell align="center">Seguro médico internacional</TableCell>
                <TableCell align="center">Interesado</TableCell>
                <TableCell align="center">Siguiente acción</TableCell>
                <TableCell align="center">Proporcionó referidos</TableCell>
                <TableCell align="center">Cantidad de referidos</TableCell>
                <TableCell align="center">Comentario</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              <EmptyTable msg="No hay datos para mostrar" colSpan={30} />
            </TableBody>
          </Table>
        </TableContainer>
      </Grid>
