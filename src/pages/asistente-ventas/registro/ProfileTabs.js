...
const ProfileTabs = () => {
  ...
  const prospectoVendedor = useSelector(state => state.prospectoSeleccionado); //useProspectoSeleccionado();
      ...
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Stack spacing={2.5} alignItems="center">
            ...
            />
            <Stack spacing={0.5} alignItems="center">
              <Typography variant="h6">{prospectoVendedor?.nombres + ' ' + prospectoVendedor?.apellidos}</Typography>
              <Typography color="secondary">{prospectoVendedor?.tipo_cuenta?.nombre_tipo}</Typography>
            </Stack>
          </Stack>
        </Grid>
