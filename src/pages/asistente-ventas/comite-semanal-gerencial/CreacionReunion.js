...
import { DIAS, MIERCOLES } from 'utils/constants';
...
const CreacionReunion = ({ crearReunion }) => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      jefe_venta_id: '',
      date: MIERCOLES // Miercoles por defecto
    },
    onSubmit: async (values) => {
      ...
      try {
        ...
        if (multiple) {
          ...
          await crearReunion(newCSGs);

          snackbar.message = 'Reuniones creadas con éxito';
          ...
          await crearReunion(newCSG);
          
          snackbar.message = 'Reunión creada con éxito';
          snackbar.alert.color = 'success';
