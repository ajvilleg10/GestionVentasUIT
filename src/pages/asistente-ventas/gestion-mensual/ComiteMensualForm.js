...
const ComiteMensualFormulario = ({ formik, data }) => {
  ...
  const validateHora = (date, inicial) => {
    ...
    if (!isBeforeNow && isInRange && duracion > 0) formik.setFieldValue('duracion', duracion);
                  ...
                  <LocalizationProvider fullWidth dateAdapter={AdapterDayjs}>
                    <DatePicker
                      ...
                      onChange={(date) => { 
                        ...
                        if (duracion > 0) formik.setFieldValue('duracion.tiempo', duracion);
...
export default ComiteMensualFormulario;
