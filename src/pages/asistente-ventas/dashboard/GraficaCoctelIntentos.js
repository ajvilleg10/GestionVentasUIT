...
import TablaIndicadoresSemanalesIntentos from './TablaIndicadoresSemanalesIntentos';
const GraficaCoctelIntentos = () => {
  ...
  return (
    <MainCard sx={{ mt: 1 }} content={false}>
      ...
      <TablaIndicadoresSemanalesIntentos />
      </Box>
      </Box>
    </MainCard>
  );
...
export default GraficaCoctelIntentos;
