...
const SiguienteAccionModal = ({ handleAcceptance, tipoCitas, siguientesAcciones, row, disabled, index }) => {
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={8}>
                  <LocalizationProvider fullWidth dateAdapter={AdapterDayjs}>
                    <DateTimePicker label="Escoja la Fecha y Hora" onChange={changeFecha} minDate={todayjs.subtract(48, 'hours')} format="DD/MM/YYYY HH:mm" />
