...
export const CSVExport = ({ data, filename, headers, tooltip }) => {
  return (
    <CSVLink data={data} filename={filename} headers={headers}>
      <Tooltip title={tooltip ?? "CSV Export"}>
        <DownloadOutlined style={{ fontSize: '24px', color: '#009688', marginTop: 4, marginRight: 4, marginLeft: 4 }} />
      </Tooltip>
    </CSVLink>
  );
};
...
const StyledGridOverlay = styled(Stack)(({ theme, height = '400px' }) => ({
  height,
  '& .ant-empty-img-1': {
...
export const EmptyTable = ({ msg, colSpan, height }) => {
  return (
    <TableRow>
      <TableCell colSpan={colSpan}>
        <StyledGridOverlay alignItems="center" justifyContent="center" spacing={1} height={height}>
