...
const TablaBonificacionesDialog = ({ handleAcceptance }) => {
  ...
  return (
    <div>
      <Button onClick={handleClickOpen('paper')}>Tabla de bonificaciones</Button>
      <Dialog
        open={open}
        onClose={handleClose}
        scroll={scroll}
      ...
      >
        <DialogTitle id="scroll-dialog-title">Tabla de bonificaciones</DialogTitle>
        ...
        <DialogActions>
          ...
          >
            Aceptar tabla de bonificaciones
          </Button>
        </DialogActions>
      </Dialog>
    </div>
...
TablaBonificacionesDialog.propTypes = {
  handleAcceptance: PropTypes.func
};

export default TablaBonificacionesDialog;
