function empleadosReordered(empleados) {
  
  const jefeDeVentas = empleados.find((empleado) => empleado.nombreTipoCuenta === "Jefe de Ventas");
  console.log('jefeDeVentas', jefeDeVentas);
  const vendedores = empleados.filter((empleado) => empleado.nombreTipoCuenta === "Vendedor");
  console.log('vendedores', vendedores);
  // const empleadosReordered = jefeDeVentas.concat(vendedores);
  const empleadosReordered = [jefeDeVentas, ...vendedores];
  console.log('empleadosReordered', empleadosReordered);
  return empleadosReordered;
}
