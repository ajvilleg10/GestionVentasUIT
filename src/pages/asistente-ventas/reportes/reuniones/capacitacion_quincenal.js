...
const ReporteCapacitacionQuincenalJefe = () => {

  const data = useSelector(state => state.reportes.showData);
  useReporteReuniones({ tipo_reunion: REUNION.Quincenal })

  useEffect(() => {
    return () => {
      console.log('Clean up estado = Reporte capacitacion quincenal jf');
  ...
  return (
    ...
    <TablaReportes
      filename='capacitacion_quincenal.csv'
...
export default ReporteCapacitacionQuincenalJefe;
